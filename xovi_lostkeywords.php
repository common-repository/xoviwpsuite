...
if(empty($xovi_options["xovi[apitoken]"])) {
    echo "<h2>".__('Lostkeywords','xovi').XOVI_PLUGINTITLE."</h2>";    
...
?>
<h2><?php echo __('Lostkeywords - Summary','xovi').XOVI_PLUGINTITLE;?> </h2>
<?php
        $xovi_tabmenu = "";
        ...
        $xovi_keywords = xovi_myLostKeywords($xovi_currentSE, $xovi_skip);   
