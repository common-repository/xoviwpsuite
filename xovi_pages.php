...
if(empty($xovi_options["xovi[apitoken]"])) {
    echo "<h2>".__('pages','xovi').XOVI_PLUGINTITLE."</h2>";    
...
?>
<h2><?php echo __('Pages - Summary','xovi').XOVI_PLUGINTITLE;?> </h2>
<?php
        $xovi_tabmenu = "";
        ...
        $xovi_pages = xovi_myPages($xovi_currentSE, $xovi_skip);  
...
<table class="wp-list-table widefat fixed" cellspacing="0">
    <thead>
        <tr>            
            <th scope="col" id="" class="" style=""><?php echo __('page','xovi');?></th>
        </tr>
    </thead>
    <tfoot>
        <tr>
...
if(empty($xovi_pages)) {   
    ...
    foreach( $xovi_pages as $val) {

        echo sprintf('<tr>
            <td scope="col" id="" class="" style=""><a target="_blank" href="%1$s">%1$s</a></td>
        </tr>', $val->url,  XOVI_CURRENT_PAGE, $xovi_currentSE);        
    }
